...
def get_requested_path(requested_path,environ):
	...
	if requested_root == '':
		...
		if sub_path == '':
			...
			path = os.path.join(os.environ['pyproot'],'opt','postprompt','tables','credentials')
			...
			if password != password_verify:
				...
				path = os.path.join(os.environ['pyproot'],'opt','postprompt','tables','credentials',uname+'.stable')
